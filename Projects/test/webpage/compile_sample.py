...
inputs = {
    "Source video:": "./sampling/gt.mp4",
    "Random sampling": "./sampling/1.gif",
    "Our sampling": "./sampling/0.gif"
}

output_video_path = os.path.join("./sampling_videos", "0.mp4")
os.makedirs("./sampling_videos",  exist_ok = True)
